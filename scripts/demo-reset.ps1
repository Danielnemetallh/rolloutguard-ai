...
Write-Host "  4. Click 'Run synthetic analysis'"
Write-Host "  5. Open DE-NRW-0107 finding (SLA-001 / SEQ-002)"
Write-Host "  6. Click 'AI explain' then 'Ask agent: September risks'"
